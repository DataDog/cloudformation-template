...
cp datadog_cloud_cost_setup.yaml datadog_cloud_cost_setup.yaml.bak
perl -pi -e "s/<BUCKET_PLACEHOLDER>/${BUCKET}/g" datadog_cloud_cost_setup.yaml
trap 'mv datadog_cloud_cost_setup.yaml.bak datadog_cloud_cost_setup.yaml' EXIT
...
echo "https://console.aws.amazon.com/cloudformation/home#/stacks/create/review?stackName=datadog-cloud-cost-setup&templateURL=https://${BUCKET}.s3.amazonaws.com/aws/datadog_cloud_cost_setup.yaml"
