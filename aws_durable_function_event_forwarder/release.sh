...
echo "https://console.aws.amazon.com/cloudformation/home#/stacks/create/review?stackName=datadog-durable-function-event-forwarder&templateURL=https://${BUCKET}.s3.amazonaws.com/aws/durable_function_event_forwarder.yaml"
